...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //If activePlayer is equal to 'O', the o.phg is placed in HTML.
            select.style.backgroundImage = 'url("./images/o2.png")';
        }
        //squareNumberf and activePlayer are concatenated together and added to array.
    ...
    //This function results in a random squaare being selected.
...
//placement sound ('./media/myplace.wav')
...
//This function utilitizes html canvas to draw win lines.
